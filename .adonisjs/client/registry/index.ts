...
const routes = {
  ...
  'subscription.subscription.show': {
    ...
    tokens: [{"old":"/api/v1/account/subscription","type":0,"val":"api","end":""},{"old":"/api/v1/account/subscription","type":0,"val":"v1","end":""},{"old":"/api/v1/account/subscription","type":0,"val":"account","end":""},{"old":"/api/v1/account/subscription","type":0,"val":"subscription","end":""}],
    types: placeholder as Registry['subscription.subscription.show']['types'],
  },
  'subscription.subscription.request_upgrade': {
    methods: ["POST"],
    pattern: '/api/v1/account/subscription/upgrade-request',
    tokens: [{"old":"/api/v1/account/subscription/upgrade-request","type":0,"val":"api","end":""},{"old":"/api/v1/account/subscription/upgrade-request","type":0,"val":"v1","end":""},{"old":"/api/v1/account/subscription/upgrade-request","type":0,"val":"account","end":""},{"old":"/api/v1/account/subscription/upgrade-request","type":0,"val":"subscription","end":""},{"old":"/api/v1/account/subscription/upgrade-request","type":0,"val":"upgrade-request","end":""}],
    types: placeholder as Registry['subscription.subscription.request_upgrade']['types'],
  },
  ...
  'admin.admin_users.assign_subscription': {
    ...
    tokens: [{"old":"/api/v1/admin/users/:id/subscription","type":0,"val":"api","end":""},{"old":"/api/v1/admin/users/:id/subscription","type":0,"val":"v1","end":""},{"old":"/api/v1/admin/users/:id/subscription","type":0,"val":"admin","end":""},{"old":"/api/v1/admin/users/:id/subscription","type":0,"val":"users","end":""},{"old":"/api/v1/admin/users/:id/subscription","type":1,"val":"id","end":""},{"old":"/api/v1/admin/users/:id/subscription","type":0,"val":"subscription","end":""}],
    types: placeholder as Registry['admin.admin_users.assign_subscription']['types'],
  },
  ...
  'admin.admin_plans.index': {
    ...
    types: placeholder as Registry['admin.admin_plans.index']['types'],
  },
  'admin.admin_plans.store': {
    methods: ["POST"],
    pattern: '/api/v1/admin/plans',
    tokens: [{"old":"/api/v1/admin/plans","type":0,"val":"api","end":""},{"old":"/api/v1/admin/plans","type":0,"val":"v1","end":""},{"old":"/api/v1/admin/plans","type":0,"val":"admin","end":""},{"old":"/api/v1/admin/plans","type":0,"val":"plans","end":""}],
    types: placeholder as Registry['admin.admin_plans.store']['types'],
  },
  'admin.admin_plans.update': {
    ...
    types: placeholder as Registry['admin.admin_plans.update']['types'],
  },
  'admin.admin_plans.destroy': {
    methods: ["DELETE"],
    pattern: '/api/v1/admin/plans/:id',
    tokens: [{"old":"/api/v1/admin/plans/:id","type":0,"val":"api","end":""},{"old":"/api/v1/admin/plans/:id","type":0,"val":"v1","end":""},{"old":"/api/v1/admin/plans/:id","type":0,"val":"admin","end":""},{"old":"/api/v1/admin/plans/:id","type":0,"val":"plans","end":""},{"old":"/api/v1/admin/plans/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['admin.admin_plans.destroy']['types'],
  },
  'admin.admin_upgrade_requests.index': {
    methods: ["GET","HEAD"],
    pattern: '/api/v1/admin/upgrade-requests',
    tokens: [{"old":"/api/v1/admin/upgrade-requests","type":0,"val":"api","end":""},{"old":"/api/v1/admin/upgrade-requests","type":0,"val":"v1","end":""},{"old":"/api/v1/admin/upgrade-requests","type":0,"val":"admin","end":""},{"old":"/api/v1/admin/upgrade-requests","type":0,"val":"upgrade-requests","end":""}],
    types: placeholder as Registry['admin.admin_upgrade_requests.index']['types'],
  },
  'admin.admin_upgrade_requests.approve': {
    methods: ["POST"],
    pattern: '/api/v1/admin/upgrade-requests/:id/approve',
    tokens: [{"old":"/api/v1/admin/upgrade-requests/:id/approve","type":0,"val":"api","end":""},{"old":"/api/v1/admin/upgrade-requests/:id/approve","type":0,"val":"v1","end":""},{"old":"/api/v1/admin/upgrade-requests/:id/approve","type":0,"val":"admin","end":""},{"old":"/api/v1/admin/upgrade-requests/:id/approve","type":0,"val":"upgrade-requests","end":""},{"old":"/api/v1/admin/upgrade-requests/:id/approve","type":1,"val":"id","end":""},{"old":"/api/v1/admin/upgrade-requests/:id/approve","type":0,"val":"approve","end":""}],
    types: placeholder as Registry['admin.admin_upgrade_requests.approve']['types'],
  },
  'admin.admin_upgrade_requests.reject': {
    methods: ["POST"],
    pattern: '/api/v1/admin/upgrade-requests/:id/reject',
    tokens: [{"old":"/api/v1/admin/upgrade-requests/:id/reject","type":0,"val":"api","end":""},{"old":"/api/v1/admin/upgrade-requests/:id/reject","type":0,"val":"v1","end":""},{"old":"/api/v1/admin/upgrade-requests/:id/reject","type":0,"val":"admin","end":""},{"old":"/api/v1/admin/upgrade-requests/:id/reject","type":0,"val":"upgrade-requests","end":""},{"old":"/api/v1/admin/upgrade-requests/:id/reject","type":1,"val":"id","end":""},{"old":"/api/v1/admin/upgrade-requests/:id/reject","type":0,"val":"reject","end":""}],
    types: placeholder as Registry['admin.admin_upgrade_requests.reject']['types'],
  },
